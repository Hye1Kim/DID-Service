const fs = require('fs');
const BASE_ADDRESS_URL = '/home/pslab154/project/did-service/res/address/';
const BASE_ABI_URL = '/home/pslab154/project/did-service/res/abi/';
const DIDLedger_JSON =require('/home/pslab154/project/did-service/res/json/DIDLedger.json');
